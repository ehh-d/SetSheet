...
- Use Cloudflare tunnel (no account needed, works every time):
  ...
  - Copy the `https://xxxx.trycloudflare.com` URL from Terminal 2
  - Enter in dev app: `exp+setsheet://expo-development-client/?url=https%3A%2F%2Fxxxx.trycloudflare.com`
